    ...
    <section className="features pt-[3rem] pb-[5rem] md:pb-[10rem] px-[5%]">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 justify-between">
        {features.map((feature) => {
          ...
          return (
            <div className="relative bg-[#dbe7ea] rounded-tl-md rounded-tr-3xl rounded-br-3xl rounded-bl-3xl p-6 pt-10 shadow-sm flex flex-col items-start hover:shadow-md transition-shadow justify-self-center max-w-[100%]">
