...
const CTA = () => {
  ...
  return (
    ...
    >
      <div ref={contentRef} className="stagger-grid flex flex-col items-center">
        <h1 className="reveal-item text-4xl md:text-4xl font-[500] mb-4">
          Ready To Create Your First Survey
        </h1>
        <p className="reveal-item py-2 text-[1.1rem]">
